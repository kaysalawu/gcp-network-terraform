...
locals {
  egress_rules = {
    # ipv4
    #*************************
    "fw-${var.vpc_name}-4000-e-a-all-all-egress-internet" = {
    ...
    "fw-${var.vpc_name}-4100-e-a-google-apis-all-tcp-443" = {
    ...
    "fw-${var.vpc_name}-4200-e-a-all-all-all" = {
    ...
    # ipv6
    #*************************
    "fw-${var.vpc_name}-6000-e-a-all-all-egress-internet-ipv6" = {
    ...
    "fw-${var.vpc_name}-6100-e-a-google-apis-all-tcp-443-ipv6" = {
      description = (var.enable_restricted ?
    ...
    "fw-${var.vpc_name}-6200-e-a-all-all-all-ipv6" = {
  ...
  ingress_rules = {
    # ipv4
    #*************************
    "fw-${var.vpc_name}-4001-i-a-custom-internet-ingress" = {
    ...
    "fw-${var.vpc_name}-4201-i-a-all-private" = {
    ...
    "fw-${var.vpc_name}-4300-i-a-tcp-all-iap" = {
    ...
    "fw-${var.vpc_name}-4400-i-a-all-all-gfe" = {
    ...
    "fw-${var.vpc_name}-4500-i-a-tcp-22-ssh" = {
    ...
    "fw-${var.vpc_name}-4600-i-a-mixed-vpn" = {
    ...
    "fw-${var.vpc_name}-4700-i-a-all-dns" = {
    ...
    # ipv6
    #*************************
    "fw-${var.vpc_name}-6001-i-a-custom-internet-ingress-ipv6" = {
    ...
    "fw-${var.vpc_name}-6201-i-a-all-private-ipv6" = {
    ...
    "fw-${var.vpc_name}-6300-i-a-tcp-all-iap-ipv6" = {
      description    = "Allow IAP ingress traffic."
      priority       = 6300
      action         = "allow"
      enable_logging = true
    ...
    "fw-${var.vpc_name}-6400-i-a-all-all-gfe-ipv6" = {
    ...
    "fw-${var.vpc_name}-6500-i-a-tcp-22-ssh-ipv6" = {
    ...
    "fw-${var.vpc_name}-6600-i-a-mixed-vpn-ipv6" = {
