...
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app) - https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app"
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app) - https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app"
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app) - https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app"
EOF
...
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app) - https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app) - https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app) - https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app"
EOF
...
nping -c 5 --tcp-connect -p 80,8080 https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app > /dev/null 2>&1
EOF
...
nping -c 5 -6 --tcp-connect -p 80,8080 https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app > /dev/null 2>&1
EOF
...
while [ $i -lt 8 ]; do
  ...
  if [ $? -ne 0 ]; then
    ...
    ab -s 3 -n $1 -c $2 [$(get_ipv6 https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app failed"
    exit 1
  else
    echo "target: https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app failed"
    exit 1
  else
    echo "target: https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app failed"
    exit 1
  else
    echo "target: https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app passed"
  fi
    let i=i+1
  sleep 5
done
