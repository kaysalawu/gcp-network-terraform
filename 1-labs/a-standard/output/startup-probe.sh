...
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app) - https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app) - https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app) - https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app"
EOF
...
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app) - https://a-hub-us-run-httpbin-i6ankopyoa-nw.a.run.app"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app) - https://a-spoke1-eu-run-httpbin-2zcsnlaqcq-nw.a.run.app"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app) - https://a-spoke2-us-run-httpbin-bttbo6m6za-wl.a.run.app"
EOF
