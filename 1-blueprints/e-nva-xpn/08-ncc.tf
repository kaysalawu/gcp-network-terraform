...
resource "google_network_connectivity_spoke" "ncc_spoke1" {
  ...
  linked_vpn_tunnels {
    uris = [
      module.vpn_hub_eu_to_site1.tunnel_self_links["tun-0"],
      module.vpn_hub_eu_to_site1.tunnel_self_links["tun-1"]
    ]
...
resource "google_network_connectivity_spoke" "ncc_spoke2" {
  ...
  linked_vpn_tunnels {
    uris = [
      module.vpn_hub_us_to_site2.tunnel_self_links["tun-0"],
      module.vpn_hub_us_to_site2.tunnel_self_links["tun-1"]
    ]
    site_to_site_data_transfer = true
  }
}
