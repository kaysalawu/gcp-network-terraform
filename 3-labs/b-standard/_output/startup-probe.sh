...
echo "hub-eu-ilb    - 10.1.11.70 -$(timeout 5 ping -4 -qc2 -W1 10.1.11.70 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-eu-alb    - 10.1.11.80 -$(timeout 5 ping -4 -qc2 -W1 10.1.11.80 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-ilb - 10.11.11.30 -$(timeout 5 ping -4 -qc2 -W1 10.11.11.30 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-alb - 10.11.11.40 -$(timeout 5 ping -4 -qc2 -W1 10.11.11.40 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo "hub-us-ilb    - 10.1.21.70 -$(timeout 5 ping -4 -qc2 -W1 10.1.21.70 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-us-alb    - 10.1.21.80 -$(timeout 5 ping -4 -qc2 -W1 10.1.21.80 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-ilb - 10.22.21.30 -$(timeout 5 ping -4 -qc2 -W1 10.22.21.30 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-alb - 10.22.21.40 -$(timeout 5 ping -4 -qc2 -W1 10.22.21.40 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo "ilb.eu.hub.g.corp - $(timeout 5 dig +short ilb.eu.hub.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 ilb.eu.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.eu.hub.g.corp - $(timeout 5 dig +short alb.eu.hub.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 alb.eu.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "ilb.eu.spoke1.g.corp - $(timeout 5 dig +short ilb.eu.spoke1.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 ilb.eu.spoke1.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.eu.spoke1.g.corp - $(timeout 5 dig +short alb.eu.spoke1.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 alb.eu.spoke1.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo "ilb.us.hub.g.corp - $(timeout 5 dig +short ilb.us.hub.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 ilb.us.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.us.hub.g.corp - $(timeout 5 dig +short alb.us.hub.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 alb.us.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "ilb.us.spoke2.g.corp - $(timeout 5 dig +short ilb.us.spoke2.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 ilb.us.spoke2.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.us.spoke2.g.corp - $(timeout 5 dig +short alb.us.spoke2.g.corp | tail -n1) -$(timeout 5 ping -4 -qc2 -W1 alb.us.spoke2.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.1.11.70) - hub-eu-ilb    [10.1.11.70]"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.1.11.80) - hub-eu-alb    [10.1.11.80]"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.11.11.30) - spoke1-eu-ilb [10.11.11.30]"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.11.11.40) - spoke1-eu-alb [10.11.11.40]"
...
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.1.21.70) - hub-us-ilb    [10.1.21.70]"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.1.21.80) - hub-us-alb    [10.1.21.80]"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.22.21.30) - spoke2-us-ilb [10.22.21.30]"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.22.21.40) - spoke2-us-alb [10.22.21.40]"
...
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.eu.hub.g.corp) - ilb.eu.hub.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.eu.hub.g.corp) - alb.eu.hub.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.eu.spoke1.g.corp) - ilb.eu.spoke1.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.eu.spoke1.g.corp) - alb.eu.spoke1.g.corp"
...
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.us.hub.g.corp) - ilb.us.hub.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.us.hub.g.corp) - alb.us.hub.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.us.spoke2.g.corp) - ilb.us.spoke2.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.us.spoke2.g.corp) - alb.us.spoke2.g.corp"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.geo.hub.g.corp) - ilb.geo.hub.g.corp"
...
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://b-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app) - https://b-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://b-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app) - https://b-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app"
echo  "$(timeout 5 curl -4 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://b-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app) - https://b-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app"
EOF
...
echo "spoke1-eu-alb - 10.11.11.40 --> $ptr_record [$arpa_zone]"
...
echo "spoke2-us-alb - 10.22.21.40 --> $ptr_record [$arpa_zone]"
EOF
...
echo "hub-eu-ilb    - fd00:10:1:11::46 -$(timeout 5 ping -6 -qc2 -W1 fd00:10:1:11::46 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-eu-alb    - fd00:10:1:11::50 -$(timeout 5 ping -6 -qc2 -W1 fd00:10:1:11::50 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-ilb - fd00:10:11:11::1e -$(timeout 5 ping -6 -qc2 -W1 fd00:10:11:11::1e 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-alb - fd00:10:11:11::28 -$(timeout 5 ping -6 -qc2 -W1 fd00:10:11:11::28 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo "hub-us-ilb    - fd00:10:1:21::46 -$(timeout 5 ping -6 -qc2 -W1 fd00:10:1:21::46 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-us-alb    - fd00:10:1:21::50 -$(timeout 5 ping -6 -qc2 -W1 fd00:10:1:21::50 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-ilb - fd00:10:22:21::1e -$(timeout 5 ping -6 -qc2 -W1 fd00:10:22:21::1e 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-alb - fd00:10:22:21::28 -$(timeout 5 ping -6 -qc2 -W1 fd00:10:22:21::28 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo "ilb.eu.hub.g.corp - $(timeout 5 dig AAAA +short ilb.eu.hub.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 ilb.eu.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.eu.hub.g.corp - $(timeout 5 dig AAAA +short alb.eu.hub.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 alb.eu.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "ilb.eu.spoke1.g.corp - $(timeout 5 dig AAAA +short ilb.eu.spoke1.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 ilb.eu.spoke1.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.eu.spoke1.g.corp - $(timeout 5 dig AAAA +short alb.eu.spoke1.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 alb.eu.spoke1.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo "ilb.us.hub.g.corp - $(timeout 5 dig AAAA +short ilb.us.hub.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 ilb.us.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.us.hub.g.corp - $(timeout 5 dig AAAA +short alb.us.hub.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 alb.us.hub.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "ilb.us.spoke2.g.corp - $(timeout 5 dig AAAA +short ilb.us.spoke2.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 ilb.us.spoke2.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "alb.us.spoke2.g.corp - $(timeout 5 dig AAAA +short alb.us.spoke2.g.corp | tail -n1) -$(timeout 5 ping -6 -qc2 -W1 alb.us.spoke2.g.corp 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:11::46]) - hub-eu-ilb    [fd00:10:1:11::46]"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:11::50]) - hub-eu-alb    [fd00:10:1:11::50]"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:11:11::1e]) - spoke1-eu-ilb [fd00:10:11:11::1e]"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:11:11::28]) - spoke1-eu-alb [fd00:10:11:11::28]"
...
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:21::46]) - hub-us-ilb    [fd00:10:1:21::46]"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:21::50]) - hub-us-alb    [fd00:10:1:21::50]"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:22:21::1e]) - spoke2-us-ilb [fd00:10:22:21::1e]"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:22:21::28]) - spoke2-us-alb [fd00:10:22:21::28]"
...
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.eu.hub.g.corp) - ilb.eu.hub.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.eu.hub.g.corp) - alb.eu.hub.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.eu.spoke1.g.corp) - ilb.eu.spoke1.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.eu.spoke1.g.corp) - alb.eu.spoke1.g.corp"
...
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.us.hub.g.corp) - ilb.us.hub.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.us.hub.g.corp) - alb.us.hub.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.us.spoke2.g.corp) - ilb.us.spoke2.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null alb.us.spoke2.g.corp) - alb.us.spoke2.g.corp"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null ilb.geo.hub.g.corp) - ilb.geo.hub.g.corp"
...
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://b-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app) - https://b-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://b-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app) - https://b-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app"
echo  "$(timeout 5 curl -6 -kL --max-time 5.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://b-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app) - https://b-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app"
EOF
...
nping -c 5 --tcp-connect -p 80,8080 ilb.eu.hub.g.corp > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 alb.eu.hub.g.corp > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 ilb.eu.spoke1.g.corp > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 alb.eu.spoke1.g.corp > /dev/null 2>&1
...
nping -c 5 --tcp-connect -p 80,8080 ilb.us.hub.g.corp > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 alb.us.hub.g.corp > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 ilb.us.spoke2.g.corp > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 alb.us.spoke2.g.corp > /dev/null 2>&1
...
while [ $i -lt 5 ]; do
    ...
    ab -n $1 -c $2 ilb.eu.hub.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 alb.eu.hub.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 ilb.eu.spoke1.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 alb.eu.spoke1.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 vm.site2.corp > /dev/null 2>&1
    ab -n $1 -c $2 vm.us.hub.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 vm.us.spoke2.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 ilb.us.hub.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 alb.us.hub.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 ilb.us.spoke2.g.corp > /dev/null 2>&1
    ab -n $1 -c $2 alb.us.spoke2.g.corp > /dev/null 2>&1
...
nping -c 5 -6 --tcp-connect -p 80,8080 ilb.eu.hub.g.corp > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 alb.eu.hub.g.corp > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 ilb.eu.spoke1.g.corp > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 alb.eu.spoke1.g.corp > /dev/null 2>&1
...
nping -c 5 -6 --tcp-connect -p 80,8080 ilb.us.hub.g.corp > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 alb.us.hub.g.corp > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 ilb.us.spoke2.g.corp > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 alb.us.spoke2.g.corp > /dev/null 2>&1
...
while [ $i -lt 8 ]; do
  ...
  if [ $? -ne 0 ]; then
    ...
    ab -s 3 -n $1 -c $2 [$(get_ipv6 ilb.eu.hub.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: ilb.eu.hub.g.corp failed"
    exit 1
  else
    echo "target: ilb.eu.hub.g.corp passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 alb.eu.hub.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: alb.eu.hub.g.corp failed"
    exit 1
  else
    echo "target: alb.eu.hub.g.corp passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 ilb.eu.spoke1.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: ilb.eu.spoke1.g.corp failed"
    exit 1
  else
    echo "target: ilb.eu.spoke1.g.corp passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 alb.eu.spoke1.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: alb.eu.spoke1.g.corp failed"
    exit 1
  else
    echo "target: alb.eu.spoke1.g.corp passed"
  fi
  ...
  if [ $? -ne 0 ]; then
    ...
    ab -s 3 -n $1 -c $2 [$(get_ipv6 ilb.us.hub.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: ilb.us.hub.g.corp failed"
    exit 1
  else
    echo "target: ilb.us.hub.g.corp passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 alb.us.hub.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: alb.us.hub.g.corp failed"
    exit 1
  else
    echo "target: alb.us.hub.g.corp passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 ilb.us.spoke2.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: ilb.us.spoke2.g.corp failed"
    exit 1
  else
    echo "target: ilb.us.spoke2.g.corp passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 alb.us.spoke2.g.corp)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: alb.us.spoke2.g.corp failed"
    exit 1
  else
    echo "target: alb.us.spoke2.g.corp passed"
  fi
