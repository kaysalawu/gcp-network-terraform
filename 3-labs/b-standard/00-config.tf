...
locals {
  ...
  hub_subnets_eu = {
    ...
    eu-psc-ilb4-nat  = { region = local.hub_eu_region, ip_cidr_range = "10.1.14.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb4-nat6 = { region = local.hub_eu_region, ip_cidr_range = "10.1.15.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-nlb4-nat  = { region = local.hub_eu_region, ip_cidr_range = "10.1.16.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-nlb4-nat6 = { region = local.hub_eu_region, ip_cidr_range = "10.1.17.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb4-nat  = { region = local.hub_eu_region, ip_cidr_range = "10.1.18.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb4-nat6 = { region = local.hub_eu_region, ip_cidr_range = "10.1.19.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
  }
  hub_subnets_us = {
    ...
    us-psc-ilb4-nat  = { region = local.hub_us_region, ip_cidr_range = "10.1.24.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb4-nat6 = { region = local.hub_us_region, ip_cidr_range = "10.1.25.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-nlb4-nat  = { region = local.hub_us_region, ip_cidr_range = "10.1.26.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-nlb4-nat6 = { region = local.hub_us_region, ip_cidr_range = "10.1.27.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb4-nat  = { region = local.hub_us_region, ip_cidr_range = "10.1.28.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb4-nat6 = { region = local.hub_us_region, ip_cidr_range = "10.1.29.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
  }
  ...
  hub_eu_ep_spoke1_eu_psc_ilb4_prefix = "ep.eu.spoke1-eu-ilb4"
  hub_eu_ep_spoke1_eu_psc_nlb4_prefix = "ep.eu.spoke1-eu-nlb4"
  hub_eu_ep_spoke1_eu_psc_ilb7_prefix = "ep.eu.spoke1-eu-ilb7"
  hub_eu_ep_spoke1_eu_psc_ilb4_fqdn   = "${local.hub_eu_ep_spoke1_eu_psc_ilb4_prefix}.${local.hub_dns_zone}"
  hub_eu_ep_spoke1_eu_psc_nlb4_fqdn   = "${local.hub_eu_ep_spoke1_eu_psc_nlb4_prefix}.${local.hub_dns_zone}"
  hub_eu_ep_spoke1_eu_psc_ilb7_fqdn   = "${local.hub_eu_ep_spoke1_eu_psc_ilb7_prefix}.${local.hub_dns_zone}"

  # hub_us_ep_spoke1_us_psc_ilb4_prefix = "ep.us.spoke1-eu-ilb4"
  # hub_us_ep_spoke1_us_psc_nlb4_prefix = "ep.us.spoke1-eu-nlb4"
  # hub_us_ep_spoke1_us_psc_ilb7_prefix = "ep.us.spoke1-eu-ilb7"
  # hub_us_ep_spoke1_us_psc_ilb4_fqdn   = "${local.hub_us_ep_spoke1_us_psc_ilb4_prefix}.${local.hub_dns_zone}"
  # hub_us_ep_spoke1_us_psc_nlb4_fqdn   = "${local.hub_us_ep_spoke1_us_psc_nlb4_prefix}.${local.hub_dns_zone}"
  # hub_us_ep_spoke1_us_psc_ilb7_fqdn   = "${local.hub_us_ep_spoke1_us_psc_ilb7_prefix}.${local.hub_dns_zone}"
...
locals {
  ...
  spoke1_subnets_eu = {
    ...
    eu-psc-ilb4-nat  = { region = local.spoke1_eu_region, ip_cidr_range = "10.11.14.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb4-nat6 = { region = local.spoke1_eu_region, ip_cidr_range = "10.11.15.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-nlb4-nat  = { region = local.spoke1_eu_region, ip_cidr_range = "10.11.16.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-nlb4-nat6 = { region = local.spoke1_eu_region, ip_cidr_range = "10.11.17.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb7-nat  = { region = local.spoke1_eu_region, ip_cidr_range = "10.11.18.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb7-nat6 = { region = local.spoke1_eu_region, ip_cidr_range = "10.11.19.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
  }
  spoke1_subnets_us = {
    ...
    us-psc-ilb4-nat  = { region = local.spoke1_us_region, ip_cidr_range = "10.11.24.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb4-nat6 = { region = local.spoke1_us_region, ip_cidr_range = "10.11.25.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-nlb4-nat  = { region = local.spoke1_us_region, ip_cidr_range = "10.11.26.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-nlb4-nat6 = { region = local.spoke1_us_region, ip_cidr_range = "10.11.27.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb7-nat  = { region = local.spoke1_us_region, ip_cidr_range = "10.11.28.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb7-nat6 = { region = local.spoke1_us_region, ip_cidr_range = "10.11.29.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
  }
  ...
  spoke1_eu_nlb4_dns_prefix = "nlb4.eu"
  ...
  spoke1_us_nlb4_dns_prefix = "nlb4.us"
...
locals {
  ...
  spoke2_subnets_eu = {
    ...
    eu-psc-ilb4-nat  = { region = local.spoke2_eu_region, ip_cidr_range = "10.22.14.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb4-nat6 = { region = local.spoke2_eu_region, ip_cidr_range = "10.22.15.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-nlb4-nat  = { region = local.spoke2_eu_region, ip_cidr_range = "10.22.16.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-nlb4-nat6 = { region = local.spoke2_eu_region, ip_cidr_range = "10.22.17.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb7-nat  = { region = local.spoke2_eu_region, ip_cidr_range = "10.22.18.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    eu-psc-ilb7-nat6 = { region = local.spoke2_eu_region, ip_cidr_range = "10.22.19.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
  }
  spoke2_subnets_us = {
    ...
    us-psc-ilb4-nat  = { region = local.spoke2_us_region, ip_cidr_range = "10.22.24.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb4-nat6 = { region = local.spoke2_us_region, ip_cidr_range = "10.22.25.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-nlb4-nat  = { region = local.spoke2_us_region, ip_cidr_range = "10.22.26.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-nlb4-nat6 = { region = local.spoke2_us_region, ip_cidr_range = "10.22.27.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb7-nat  = { region = local.spoke2_us_region, ip_cidr_range = "10.22.28.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
    us-psc-ilb7-nat6 = { region = local.spoke2_us_region, ip_cidr_range = "10.22.29.0/24", ipv6 = {}, enable_private_access = false, purpose = "PRIVATE_SERVICE_CONNECT" }
  }
  ...
  spoke2_eu_nlb4_addr                  = cidrhost(local.spoke2_subnets["eu-main"].ip_cidr_range, 40)
  spoke2_eu_ilb7_addr                  = cidrhost(local.spoke2_subnets["eu-main"].ip_cidr_range, 50)
  spoke2_eu_ep_spoke1_eu_psc_ilb4_addr = cidrhost(local.spoke2_subnets["eu-main"].ip_cidr_range, 60)
  spoke2_eu_ep_spoke1_eu_psc_nlb4_addr = cidrhost(local.spoke2_subnets["eu-main"].ip_cidr_range, 70)
  spoke2_eu_ep_spoke1_eu_psc_ilb7_addr = cidrhost(local.spoke2_subnets["eu-main"].ip_cidr_range, 80)
  ...
  spoke2_us_nlb4_addr                  = cidrhost(local.spoke2_subnets["us-main"].ip_cidr_range, 40)
  spoke2_us_ilb7_addr                  = cidrhost(local.spoke2_subnets["us-main"].ip_cidr_range, 50)
  spoke2_us_ep_spoke1_eu_psc_ilb4_addr = cidrhost(local.spoke2_subnets["us-main"].ip_cidr_range, 60)
  spoke2_us_ep_spoke1_eu_psc_nlb4_addr = cidrhost(local.spoke2_subnets["us-main"].ip_cidr_range, 70)
  spoke2_us_ep_spoke1_eu_psc_ilb7_addr = cidrhost(local.spoke2_subnets["us-main"].ip_cidr_range, 80)
  ...
  spoke2_eu_nlb4_dns_prefix = "nlb4.eu"
  ...
  spoke2_us_nlb4_dns_prefix = "nlb4.us"
  ...
  # psc endpoints ( to spoke1 published services)
  spoke2_eu_ep_spoke1_eu_psc_ilb4_prefix = "ep.eu.spoke1-eu-ilb4"
  spoke2_eu_ep_spoke1_eu_psc_nlb4_prefix = "ep.eu.spoke1-eu-nlb4"
  spoke2_eu_ep_spoke1_eu_psc_ilb7_prefix = "ep.eu.spoke1-eu-ilb7"
  spoke2_eu_ep_spoke1_eu_psc_ilb4_fqdn   = "${local.spoke2_eu_ep_spoke1_eu_psc_ilb4_prefix}.${local.spoke2_dns_zone}"
  spoke2_eu_ep_spoke1_eu_psc_nlb4_fqdn   = "${local.spoke2_eu_ep_spoke1_eu_psc_nlb4_prefix}.${local.spoke2_dns_zone}"
  spoke2_eu_ep_spoke1_eu_psc_ilb7_fqdn   = "${local.spoke2_eu_ep_spoke1_eu_psc_ilb7_prefix}.${local.spoke2_dns_zone}"

  # spoke2_us_ep_spoke1_us_psc_ilb4_prefix = "ep.us.spoke1-eu-ilb4"
  # spoke2_us_ep_spoke1_us_psc_nlb4_prefix = "ep.us.spoke1-eu-nlb4"
  # spoke2_us_ep_spoke1_us_psc_ilb7_prefix = "ep.us.spoke1-eu-ilb7"
  # spoke2_us_ep_spoke1_us_psc_ilb4_fqdn   = "${local.spoke2_us_ep_spoke1_us_psc_ilb4_prefix}.${local.spoke2_dns_zone}"
  # spoke2_us_ep_spoke1_us_psc_nlb4_fqdn   = "${local.spoke2_us_ep_spoke1_us_psc_nlb4_prefix}.${local.spoke2_dns_zone}"
  # spoke2_us_ep_spoke1_us_psc_ilb7_fqdn   = "${local.spoke2_us_ep_spoke1_us_psc_ilb7_prefix}.${local.spoke2_dns_zone}"
