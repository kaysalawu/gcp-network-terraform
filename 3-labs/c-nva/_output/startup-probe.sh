...
echo "spoke2-us-ilb7 - 10.22.21.40 -$(timeout 3 ping -4 -qc2 -W1 10.22.21.40 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null 10.22.21.40) - spoke2-us-ilb7 [10.22.21.40]"
...
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app) - https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app"
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app) - https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app"
echo  "$(timeout 3 curl -4 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app) - https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app"
EOF
...
echo -e "\n ping ipv6 ...\n"
echo "site1-vm       - fd00:10:10:1::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:10:1::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-eu-vm      - fd00:10:1:11::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:1:11::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-vm   - fd00:10:11:11::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:11:11::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-eu-vm   - fd00:10:22:11::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:22:11::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-eu-ilb4    - fd00:10:1:11::46 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:1:11::46 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-eu-ilb7    - fd00:10:1:11::50 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:1:11::50 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-ilb4 - fd00:10:11:11::1e -$(timeout 3 ping -6 -qc2 -W1 fd00:10:11:11::1e 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke1-eu-ilb7 - fd00:10:11:11::28 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:11:11::28 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "site2-vm       - fd00:10:20:1::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:20:1::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-us-vm      - fd00:10:1:21::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:1:21::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-vm   - fd00:10:22:21::9 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:22:21::9 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-us-ilb4    - fd00:10:1:21::46 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:1:21::46 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "hub-us-ilb7    - fd00:10:1:21::50 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:1:21::50 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-ilb4 - fd00:10:22:21::1e -$(timeout 3 ping -6 -qc2 -W1 fd00:10:22:21::1e 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
echo "spoke2-us-ilb7 - fd00:10:22:21::28 -$(timeout 3 ping -6 -qc2 -W1 fd00:10:22:21::28 2>&1 | awk -F'/' 'END{ print (/^rtt/? "OK "$5" ms":"NA") }')"
...
echo -e "\n curl ipv6 ...\n"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:10:1::9]) - site1-vm       [fd00:10:10:1::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:11::9]) - hub-eu-vm      [fd00:10:1:11::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:11:11::9]) - spoke1-eu-vm   [fd00:10:11:11::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:22:11::9]) - spoke2-eu-vm   [fd00:10:22:11::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:11::46]) - hub-eu-ilb4    [fd00:10:1:11::46]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:11::50]) - hub-eu-ilb7    [fd00:10:1:11::50]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:11:11::1e]) - spoke1-eu-ilb4 [fd00:10:11:11::1e]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:11:11::28]) - spoke1-eu-ilb7 [fd00:10:11:11::28]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:20:1::9]) - site2-vm       [fd00:10:20:1::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:21::9]) - hub-us-vm      [fd00:10:1:21::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:22:21::9]) - spoke2-us-vm   [fd00:10:22:21::9]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:21::46]) - hub-us-ilb4    [fd00:10:1:21::46]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:1:21::50]) - hub-us-ilb7    [fd00:10:1:21::50]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:22:21::1e]) - spoke2-us-ilb4 [fd00:10:22:21::1e]"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null [fd00:10:22:21::28]) - spoke2-us-ilb7 [fd00:10:22:21::28]"
...
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app) - https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app) - https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app"
echo  "$(timeout 3 curl -6 -kL --max-time 3.0 -H 'Cache-Control: no-cache' -w "%{http_code} (%{time_total}s) - %{remote_ip}" -s -o /dev/null https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app) - https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app"
EOF
...
nping -c 5 --tcp-connect -p 80,8080 https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app > /dev/null 2>&1
nping -c 5 --tcp-connect -p 80,8080 https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app > /dev/null 2>&1
EOF
...
while [ $i -lt 5 ]; do
    ...
    ab -n $1 -c $2 https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app > /dev/null 2>&1
    ab -n $1 -c $2 https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app > /dev/null 2>&1
    ab -n $1 -c $2 https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app > /dev/null 2>&1
    let i=i+1
  sleep 5
done
EOF
...
nping -c 5 -6 --tcp-connect -p 80,8080 https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app > /dev/null 2>&1
nping -c 5 -6 --tcp-connect -p 80,8080 https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app > /dev/null 2>&1
EOF
...
while [ $i -lt 8 ]; do
  ...
  if [ $? -ne 0 ]; then
    ...
    ab -s 3 -n $1 -c $2 [$(get_ipv6 https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app failed"
    exit 1
  else
    echo "target: https://c-hub-us-run-httpbin-wapotrwjpq-nw.a.run.app passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app failed"
    exit 1
  else
    echo "target: https://c-spoke1-eu-run-httpbin-expmorqqnq-nw.a.run.app passed"
  fi
    ab -s 3 -n $1 -c $2 [$(get_ipv6 https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app)]/ > /dev/null 2>&1
  # check if ab command was successful
  if [ $? -ne 0 ]; then
    echo "target: https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app failed"
    exit 1
  else
    echo "target: https://c-spoke2-us-run-httpbin-4e4skt6nna-wl.a.run.app passed"
  fi
    let i=i+1
  sleep 5
done
