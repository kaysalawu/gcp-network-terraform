...
locals {
  ...
  vm_script_targets_region1 = [
    { name = "site1-vm      ", host = local.site1_vm, ipv4 = local.site1_vm_addr, ipv6 = local.site1_vm_addr_v6, probe = false },
    { name = "hub-eu-vm     ", host = local.hub_eu_vm, ipv4 = local.hub_eu_vm_addr, ipv6 = local.hub_eu_vm_addr_v6, probe = false },
    { name = "spoke1-eu-vm  ", host = local.spoke1_eu_vm, ipv4 = local.spoke1_eu_vm_addr, ipv6 = local.spoke1_eu_vm_addr_v6, probe = false },
    { name = "spoke2-eu-vm  ", host = local.spoke2_eu_vm, ipv4 = local.spoke2_eu_vm_addr, ipv6 = local.spoke2_eu_vm_addr_v6, probe = false },
    { name = "hub-eu-ilb4   ", host = local.hub_eu_ilb4, ipv4 = local.hub_eu_ilb4_addr, ipv6 = local.hub_eu_ilb4_addr_v6, probe = false },
    { name = "hub-eu-ilb7   ", host = local.hub_eu_ilb7, ipv4 = local.hub_eu_ilb7_addr, ipv6 = local.hub_eu_ilb7_addr_v6, probe = false },
    { name = "spoke1-eu-ilb4", host = local.spoke1_eu_ilb4, ipv4 = local.spoke1_eu_ilb4_addr, ipv6 = local.spoke1_eu_ilb4_addr_v6, probe = false },
    { name = "spoke1-eu-ilb7", host = local.spoke1_eu_ilb7, ipv4 = local.spoke1_eu_ilb7_addr, ipv6 = local.spoke1_eu_ilb7_addr_v6, probe = false },
  ]
  vm_script_targets_region2 = [
    { name = "site2-vm      ", host = local.site2_vm, ipv4 = local.site2_vm_addr, ipv6 = local.site2_vm_addr_v6, probe = false },
    { name = "hub-us-vm     ", host = local.hub_us_vm, ipv4 = local.hub_us_vm_addr, ipv6 = local.hub_us_vm_addr_v6, probe = false },
    { name = "spoke2-us-vm  ", host = local.spoke2_us_vm, ipv4 = local.spoke2_us_vm_addr, ipv6 = local.spoke2_us_vm_addr_v6, probe = false },
    { name = "hub-us-ilb4   ", host = local.hub_us_ilb4, ipv4 = local.hub_us_ilb4_addr, ipv6 = local.hub_us_ilb4_addr_v6, probe = false },
    { name = "hub-us-ilb7   ", host = local.hub_us_ilb7, ipv4 = local.hub_us_ilb7_addr, ipv6 = local.hub_us_ilb7_addr_v6, probe = false },
    { name = "spoke2-us-ilb4", host = local.spoke2_us_ilb4, ipv4 = local.spoke2_us_ilb4_addr, ipv6 = local.spoke2_us_ilb4_addr_v6, probe = false },
    { name = "spoke2-us-ilb7", host = local.spoke2_us_ilb7, ipv4 = local.spoke2_us_ilb7_addr, ipv6 = local.spoke2_us_ilb7_addr_v6, probe = false },
  ]
  vm_script_targets_misc = [
    ...
    # { name = "hub-us-run", host = "${local.hub_us_run_httpbin_host}", probe = false, path = "/generate_204" },
